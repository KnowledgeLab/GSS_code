...
article = [a for a in articleClasses if a.articleID == 3168][0]
...
# recode 
moneyOriented = design['JOBINC'].copy()[design['JOBINC']!=1]=0
design['MONEYORIENTED'] = pd.Series(moneyOriented, index=design.index)

# create formula
formula = 'MONEYORIENTED ~ C(OCC)'
